<!-- page content -->
      ...
      <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
          ...
          <form role="form" method="post" action="<?=base_url('moduluser/updateUser')?>" enctype="multipart/form-data" class="form-horizontal form-label-left">
          ...
          <input value="<?= $user['id_user'];?>" type="hidden" name="id_user">
            ...
            <div class="form-group">
              ...
              <div class="col-md-10 col-sm-6 col-xs-12">
                <input type="text" name="username" value="<?= $user['username'];?>" required="required" class="form-control col-md-7 col-xs-12">
              </div>
            </div>
            <br>
          ...
          <div class="form-group">
            ...
            <div class="col-md-10 col-sm-6 col-xs-12">
              <input type="text" name="nomor_telpon" value="<?= $user['nomor_telpon'];?>" required="required" class="form-control col-md-7 col-xs-12">
            </div>
          </div>
          <br>
          <div class="form-group">
